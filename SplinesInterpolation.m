...
for i = 1:3
    ...
    plot(interpolatedValues(:,1), interpolatedValues(:,2)), xlabel("Dystans"), ylabel("Wysokość"), title(strcat("Interpolacja splajnami 3 stopnia - ", Titles(i))), xlim([xmin, xmax]), ylim([ymin, ymax])
end